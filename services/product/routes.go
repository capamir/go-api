...
func (h *Handler) handleCreateProduct(res http.ResponseWriter, req *http.Request) {
	var product types.CreateProductPayload
	if err := utils.ParseJSON(req, &product); err != nil {
	...
	utils.WriteJSON(res, http.StatusCreated, product)
}